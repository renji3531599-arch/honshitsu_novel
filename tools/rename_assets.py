...
BG = [
    ...
    ("BG10", "bg_toshoshitsu_oku_shoko", "図書室奥の書庫（埃っぽい）", "shoko"),
    ...
    ("BG20", "bg_hawaii_yougan_daichi_kaisou", "回想・ハワイの溶岩台地", "hawaii"),
    ("BG21", "bg_yama_kaisou", "回想・稲葉と勝也がいた山（褪色調）", "yama"),
    ("BG22", "bg_daigaku_camp_kaisou", "回想・大学時代の野外調査ベースキャンプ", "camp"),
...
CHR = [
    ("katsuya", "塀勝也", [
        ...
        ("04", "驚き", "odoroki"),
        ("05", "目を伏せる", "me_fuseru"),
        ("06", "硬い無表情", "katai_muhyoujou"),
        ("07", "回想・目を細める", "kaisou_me_hosomeru"),
        ("08", "涙をこらえる", "namida_koraeru"),
        ("09", "泣く", "naku"),
        ("10", "晴れやかな笑み", "hareyaka_emi"),
    ]),
    ("ryoma", "両馬二郎", [
        ("01", "通常", "tsuujou"),
        ("02", "ニヤリ", "niyari"),
    ...
    ("mie", "三重県臣", [
        ...
        ("02", "「は？」", "ha"),
        ("03", "動揺", "douyou"),
        ("04", "気まずい沈黙", "kimazui_chinmoku"),
        ("05", "照れ", "tere"),
        ("06", "苛立ち混じりの真剣", "iradachi_shinken"),
    ...
    ("terachi", "寺地星", [
        ...
        ("02", "困惑して固まる", "konwaku_katamaru"),
        ("03", "真剣な配信者の顔", "haishin_shinken"),
        ("04", "嬉しい", "ureshii"),
    ...
    ("satou", "砂糖東洋", [
        ...
        ("06", "微笑み（レア）", "hohoemi"),
        ("07", "言葉に詰まる顔", "tsumaru"),
        ("08", "目に光るものを堪える顔", "me_hikari_koraeru"),
    ]),
    ("rei", "数理零", [
        ("01", "通常（涼しい顔）", "suzushii"),
        ("02", "微笑", "hohoemi"),
    ...
    ("izaki", "伊崎", [
        ...
        ("04", "真剣（仕切る顔）", "shikiri"),
        ("05", "驚き", "odoroki"),
        ("06", "しみじみとした微笑み", "shimijimi_hohoemi"),
    ]),
    ("izumi", "伊豆見", [
        ("01", "通常", "tsuujou"),
        ("02", "笑顔", "egao"),
    ...
    ("inaba", "稲葉悌二（回想専用）", [
        ("01", "古写真の中の柔らかい笑み", "furushashin_hohoemi"),
...
CG_MAIN = [
    ...
    ("cg29", "cg_29_katsuya_fuhou_silhouette", "勝也（回想の切れ目）／BG21。訃報を知った瞬間、シルエットのみ。"),
