...
|---|---|---|---|
| BG01 | white_001.png | `bg_hokutou_kyoshitsu_asa.png` | 北棟三年B組教室・朝 |
| BG02 | white_002.png | `bg_hokutou_kyoshitsu_hiru.png` | 北棟三年B組教室・昼休み |
| BG03 | white_003.png | `bg_hokutou_kyoshitsu_yuugata.png` | 北棟三年B組教室・夕方(茜色・逆光) |
| BG04 | white_004.png | `bg_hokutou_kyoshitsu_yoru.png` | 北棟三年B組教室・誰もいない夜 |
| BG05 | white_005.png | `bg_rouka_hokutou.png` | 北棟廊下 |
| BG06 | white_006.png | `bg_kaidan_odoriba.png` | 階段の踊り場 |
...
| BG10 | white_010.png | `bg_toshokan_shozoko.png` | 図書室奥の書庫 |
| BG11 | white_011.png | `bg_suiko_hotori.png` | 翠湖のほとり |
| BG12 | white_012.png | `bg_koutei_bunkasai_junbi.png` | 文化祭/謝恩会準備中の校庭 |
| BG13 | white_013.png | `bg_taiikukan.png` | 体育館 |
| BG14 | white_014.png | `bg_okujou.png` | 屋上 |
| BG15 | white_015.png | `bg_tsuugaku_densha_mado.png` | 通学電車の車窓 |
| BG16 | white_016.png | `bg_sakura_namiki.png` | 南棟と北棟を繋ぐ桜並木 |
| BG17 | white_017.png | `bg_sotsugyoushiki_kaijou.png` | 卒業式会場 |
| BG18 | white_018.png | `bg_minamitou_kyoshitsu.png` | 南棟三年教室 |
| BG19 | white_019.png | `bg_ryoma_ie_butsudan.png` | 両馬の家・仏壇のある部屋 |
| BG20 | white_020.png | `bg_hawaii_youganchi_kaisou.png` | 回想・ハワイの溶岩台地 |
| BG21 | white_021.png | `bg_yama_gensho_kaisou.png` | 回想・稲葉と勝也がいた山 |
| BG22 | white_022.png | `bg_daigaku_yakou_kaisou.png` | 回想・大学時代の野外調査ベースキャンプ |
| BG23 | white_023.png | `bg_kyoshitsu_haru_sotsugyougo.png` | 卒業後の春・もぬけの殻の教室 |
...
| スロット | 元ファイル | 新ファイル名 | 内容 |
|---|---|---|---|
| | white_025.png | `chr_katsuya_01_tsujou.png` | 塀勝也・表情1(通常(穏やか)) |
| | white_026.png | `chr_katsuya_02_bishou.png` | 塀勝也・表情2(微笑) |
| | white_027.png | `chr_katsuya_03_tooi_me.png` | 塀勝也・表情3(遠い目) |
| | white_028.png | `chr_katsuya_04_odoroki.png` | 塀勝也・表情4(驚き) |
| | white_029.png | `chr_katsuya_05_me_wo_fuseru.png` | 塀勝也・表情5(目を伏せる) |
| | white_030.png | `chr_katsuya_06_katai_muhyoujou.png` | 塀勝也・表情6(硬い無表情) |
| | white_031.png | `chr_katsuya_07_kaisou_me_hosomeru.png` | 塀勝也・表情7(回想・目を細める) |
| | white_032.png | `chr_katsuya_08_namida_koraeru.png` | 塀勝也・表情8(涙をこらえる) |
| | white_033.png | `chr_katsuya_09_naku.png` | 塀勝也・表情9(泣く) |
| | white_034.png | `chr_katsuya_10_hareyaka_emie.png` | 塀勝也・表情10(晴れやかな笑み) |
| | white_035.png | `chr_ryoma_01_tsujou.png` | 両馬二郎・表情1(通常) |
| | white_036.png | `chr_ryoma_02_niyari.png` | 両馬二郎・表情2(ニヤリ) |
| | white_037.png | `chr_ryoma_03_zenryoku.png` | 両馬二郎・表情3(全力) |
| | white_038.png | `chr_ryoma_04_kyuu_magao.png` | 両馬二郎・表情4(急に真顔) |
| | white_039.png | `chr_ryoma_05_shonbori.png` | 両馬二郎・表情5(しょんぼり) |
| | white_040.png | `chr_ryoma_06_nakiwarai.png` | 両馬二郎・表情6(泣き笑い) |
| | white_041.png | `chr_ryoma_07_ketsui_gao.png` | 両馬二郎・表情7(真剣な決意顔) |
| | white_042.png | `chr_ryoma_08_terekakushi.png` | 両馬二郎・表情8(照れ隠しで頭をかく) |
| | white_043.png | `chr_ryoma_09_goukyuu.png` | 両馬二郎・表情9(号泣) |
| | white_044.png | `chr_mie_01_tsujou_reshou.png` | 三重県臣・表情1(通常(冷笑・半目)) |
| | white_045.png | `chr_mie_02_ha.png` | 三重県臣・表情2(「は？」) |
| | white_046.png | `chr_mie_03_douryou.png` | 三重県臣・表情3(動揺) |
| | white_047.png | `chr_mie_04_kimaguse_chinmoku.png` | 三重県臣・表情4(気まずい沈黙顔) |
| | white_048.png | `chr_mie_05_tere.png` | 三重県臣・表情5(照れ) |
| | white_049.png | `chr_mie_06_iradachi_shinken.png` | 三重県臣・表情6(苛立ち混じりの真剣顔) |
| | white_050.png | `chr_mie_07_honki_shinken.png` | 三重県臣・表情7(本気の真剣顔) |
| | white_051.png | `chr_mie_08_kuchibiru_kamu.png` | 三重県臣・表情8(涙をこらえて唇を噛む) |
| | white_052.png | `chr_mie_09_sunao_hohoemi.png` | 三重県臣・表情9(初めての素直な微笑み) |
| | white_053.png | `chr_mie_10_nakigao.png` | 三重県臣・表情10(泣き顔) |
| | white_054.png | `chr_terachi_01_tsujou.png` | 寺地星・表情1(通常) |
| | white_055.png | `chr_terachi_02_konwaku_gata.png` | 寺地星・表情2(困惑して固まる) |
| | white_056.png | `chr_terachi_03_haishin_shinken.png` | 寺地星・表情3(真剣な配信者の顔) |
| | white_057.png | `chr_terachi_04_ureshii.png` | 寺地星・表情4(嬉しい) |
| | white_058.png | `chr_terachi_05_nakisou_taeru.png` | 寺地星・表情5(泣きそうなのを堪える) |
| | white_059.png | `chr_terachi_06_maiku_ketsui.png` | 寺地星・表情6(マイク前の決意顔) |
| | white_060.png | `chr_terachi_07_furue_yomiage.png` | 寺地星・表情7(声を震わせながら読み上げる) |
| | white_061.png | `chr_terachi_08_namida.png` | 寺地星・表情8(涙) |
| | white_062.png | `chr_satou_01_tsujou_geemu.png` | 砂糖東洋・表情1(通常(ゲーム画面凝視)) |
| | white_063.png | `chr_satou_02_muhyoujou.png` | 砂糖東洋・表情2(無表情(素)) |
| | white_064.png | `chr_satou_03_odoroki.png` | 砂糖東洋・表情3(驚き) |
| | white_065.png | `chr_satou_04_tere_soppo.png` | 砂糖東洋・表情4(照れ隠しでそっぽ) |
| | white_066.png | `chr_satou_05_kamera_shinken.png` | 砂糖東洋・表情5(真剣にカメラを構える) |
| | white_067.png | `chr_satou_06_hohoemi.png` | 砂糖東洋・表情6(微笑み) |
| | white_068.png | `chr_satou_07_kotoba_tsumaru.png` | 砂糖東洋・表情7(言葉に詰まる) |
| | white_069.png | `chr_satou_08_me_hikari_taeru.png` | 砂糖東洋・表情8(目に光るものを堪える) |
| | white_070.png | `chr_rei_01_tsujou.png` | 数理零・表情1(通常) |
| | white_071.png | `chr_rei_02_hohoemi.png` | 数理零・表情2(微笑) |
| | white_072.png | `chr_rei_03_kangae_chuu.png` | 数理零・表情3(考え中) |
| | white_073.png | `chr_rei_04_odoroki.png` | 数理零・表情4(驚き) |
| | white_074.png | `chr_rei_05_shinken.png` | 数理零・表情5(真剣) |
| | white_075.png | `chr_rei_06_yasashii_me.png` | 数理零・表情6(優しい目) |
| | white_076.png | `chr_rei_07_kotoba_erabu.png` | 数理零・表情7(言葉を選ぶ) |
| | white_077.png | `chr_rei_08_me_urumu.png` | 数理零・表情8(目を潤ませる) |
| | white_078.png | `chr_izaki_01_tsujou.png` | 伊崎・表情1(通常) |
| | white_079.png | `chr_izaki_02_egao.png` | 伊崎・表情2(笑顔) |
| | white_080.png | `chr_izaki_03_komari.png` | 伊崎・表情3(困り顔) |
| | white_081.png | `chr_izaki_04_shikiri_gao.png` | 伊崎・表情4(真剣(仕切る顔)) |
| | white_082.png | `chr_izaki_05_odoroki.png` | 伊崎・表情5(驚き) |
| | white_083.png | `chr_izaki_06_shimijimi.png` | 伊崎・表情6(しみじみとした微笑み) |
| | white_084.png | `chr_izumi_01_tsujou.png` | 伊豆見・表情1(通常) |
| | white_085.png | `chr_izumi_02_egao.png` | 伊豆見・表情2(笑顔) |
| | white_086.png | `chr_izumi_03_kinchou.png` | 伊豆見・表情3(緊張) |
| | white_087.png | `chr_izumi_04_ketsui.png` | 伊豆見・表情4(決意) |
| | white_088.png | `chr_izumi_05_tere.png` | 伊豆見・表情5(照れ) |
| | white_089.png | `chr_izumi_06_hokorashige.png` | 伊豆見・表情6(誇らしげ) |
| | white_090.png | `chr_meshino_01_tsujou.png` | 召野カイト・表情1(通常) |
| | white_091.png | `chr_meshino_02_kimegao.png` | 召野カイト・表情2(決め顔) |
| | white_092.png | `chr_meshino_03_tere.png` | 召野カイト・表情3(照れ) |
| | white_093.png | `chr_meshino_04_shinken.png` | 召野カイト・表情4(真剣) |
| | white_094.png | `chr_meshino_05_eigo_doya.png` | 召野カイト・表情5(英語ドヤ顔) |
| | white_095.png | `chr_meshino_06_shinmiri.png` | 召野カイト・表情6(しんみり) |
| | white_096.png | `chr_kuraishi_01_neikyou.png` | 倉石暁・表情1(通常(熱狂)) |
| | white_097.png | `chr_kuraishi_02_kangeki.png` | 倉石暁・表情2(感激) |
| | white_098.png | `chr_kuraishi_03_chousa_shinken.png` | 倉石暁・表情3(真剣(調査中)) |
| | white_099.png | `chr_kuraishi_04_shonbori.png` | 倉石暁・表情4(しょんぼり) |
| | white_100.png | `chr_kuraishi_05_hokorashige.png` | 倉石暁・表情5(誇らしげ) |
| | white_101.png | `chr_kuraishi_06_kotoba_ushinau.png` | 倉石暁・表情6(言葉を失う) |
| | white_102.png | `chr_kuraishi_07_namida_gumu.png` | 倉石暁・表情7(涙ぐむ) |
| | white_103.png | `chr_futami_01_tsujou.png` | 二見玲子・表情1(通常) |
| | white_104.png | `chr_futami_02_hohoemi.png` | 二見玲子・表情2(微笑) |
| | white_105.png | `chr_futami_03_shinpai.png` | 二見玲子・表情3(心配顔) |
| | white_106.png | `chr_futami_04_itazura_emie.png` | 二見玲子・表情4(いたずらっぽい笑み) |
| | white_107.png | `chr_futami_05_shinmiri_yokogao.png` | 二見玲子・表情5(しんみりした横顔) |
| | white_108.png | `chr_sakura_01_tsujou.png` | 櫻優・表情1(通常) |
| | white_109.png | `chr_sakura_02_kenkyuu_shinken.png` | 櫻優・表情2(真剣(研究者モード)) |
| | white_110.png | `chr_sakura_03_tere.png` | 櫻優・表情3(照れ) |
| | white_111.png | `chr_sakura_04_douryou.png` | 櫻優・表情4(動揺) |
| | white_112.png | `chr_sakura_05_egao.png` | 櫻優・表情5(笑顔) |
| | white_113.png | `chr_sakura_06_yawarakai.png` | 櫻優・表情6(柔らかい表情) |
| | white_114.png | `chr_mitsumine_01_tsujou.png` | 三峰瑠衣・表情1(通常) |
| | white_115.png | `chr_mitsumine_02_tsukkomi.png` | 三峰瑠衣・表情2(ツッコミ顔) |
| | white_116.png | `chr_mitsumine_03_egao.png` | 三峰瑠衣・表情3(笑顔) |
| | white_117.png | `chr_mitsumine_04_akire.png` | 三峰瑠衣・表情4(呆れ) |
| | white_118.png | `chr_mitsumine_05_yasashii.png` | 三峰瑠衣・表情5(優しい顔) |
| | white_119.png | `chr_mitsumine_06_ha_hamo.png` | 三峰瑠衣・表情6(「は？」(ハモり専用)) |
| | white_120.png | `chr_naitou_01_tsujou.png` | 内藤蘭・表情1(通常) |
| | white_121.png | `chr_naitou_02_hohoemi.png` | 内藤蘭・表情2(微笑) |
| | white_122.png | `chr_naitou_03_dokusho.png` | 内藤蘭・表情3(読書中) |
| | white_123.png | `chr_naitou_04_odoroki.png` | 内藤蘭・表情4(驚き) |
| | white_124.png | `chr_naitou_05_yasashii_me.png` | 内藤蘭・表情5(優しい目) |
| | white_125.png | `chr_naitou_06_sukoshi_waru.png` | 内藤蘭・表情6(少し笑う) |
| | white_126.png | `chr_inaba_01_shashin_emie.png` | 稲葉悌二(回想)・表情1(古写真の中の柔らかい笑み) |
| | white_127.png | `chr_inaba_02_yama_yokogao.png` | 稲葉悌二(回想)・表情2(山を指差す横顔) |
| | white_128.png | `chr_wakaki_01_seifuku_warau.png` | 若き日の塀勝也(回想)・表情1(学生服・笑っている) |
| | white_129.png | `chr_wakaki_02_chousa_bouzen.png` | 若き日の塀勝也(回想)・表情2(調査服・呆然) |
...
| スロット | 元ファイル | 新ファイル名 | 内容 |
|---|---|---|---|
| cg_end_true | white_168.png | `cg_end_true.png` | TRUE END「地面は、忘れない。」数年後の教室とアルバムのモンタージュ |
| cg_end_mie | white_169.png | `cg_end_mie.png` | GOOD END・三重編　教壇に立つ練習をする三重 |
| cg_end_satou | white_170.png | `cg_end_satou.png` | GOOD END・砂糖編　フィールドで堂々と空を見上げる砂糖 |
| cg_end_rei | white_171.png | `cg_end_rei.png` | GOOD END・零編　研究室で微笑む零 |
| cg_end_terachi | white_172.png | `cg_end_terachi.png` | GOOD END・寺地編　紙束が増えた机で配信を続ける寺地 |
| cg_end_ryoma | white_173.png | `cg_end_ryoma.png` | GOOD END・両馬編　祖父の墓前で笑って報告する両馬 |
| cg_end_izaki_izumi | white_174.png | `cg_end_izaki_izumi.png` | GOOD END・伊崎＋伊豆見編　別々の道を並んで歩く二人 |
| cg_end_meshino | white_175.png | `cg_end_meshino.png` | GOOD END・召野編　教壇/留学を思わせる一枚 |
| cg_end_kuraishi | white_176.png | `cg_end_kuraishi.png` | GOOD END・倉石編　後輩に「年鑑」を託す倉石 |
| cg_end_minamitou | white_177.png | `cg_end_minamitou.png` | GOOD END・南棟編　櫻と内藤、三峰を交えた穏やかな一枚 |
| cg_end_normal | white_178.png | `cg_end_normal.png` | NORMAL END　桜の下、いつも通りの日常が続く |
